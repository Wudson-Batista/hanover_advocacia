...
function ServiceCard({ title, description, icon, id }) {
    return (
        <div
            className='border border-blueGray-600 bg-white rounded p-8 text-center hover:cursor-pointer transition duration-200 shadow hover:shadow-xl hover:shadow-gold-400/20 hover:-translate-y-2'
        >
