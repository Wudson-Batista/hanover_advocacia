    ...
    return (
        ...
        inputType === 'textarea' ? (
            ...
            <div className="relative">
                <textarea type={inputType} id={`floating_${label}`} className="h-[120px] block px-2.5 pb-2.5 pt-4 w-full text-sm text-white bg-transparent rounded-lg border border-blue-grey-300 appearance-none  focus:outline-none focus:ring-0 focus:border-gold-400 peer resize-none" placeholder=" " required={isRequired} ></textarea>
